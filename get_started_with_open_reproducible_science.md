...
1. Open reproducible science involves making scientific methods, data, and outcomes available to everyone. For our ESIIL group, this likely means collaboration and sharing of data with each other.
2. I seleted Jupyter notebook. It involves using documents that contain live code spaces that can be shared within the group for projects. It can also use statisical modeling, data visualization, machine learning, etc. 
...
No. The file name has uppercase letters, and spaces between them. 
...
Menne, Matthew J., Imke Durre, Bryant Korzeniewski, Shelley McNeill, Kristy Thomas, Xungang Yin, Steven Anthony, Ron Ray, Russell S. Vose, Byron E.Gleason, and Tamara G. Houston (2012): Global Historical Climatology Network - Daily (GHCN-Daily), Version 3. [indicate subset used]. NOAA National Climatic Data Center. doi:10.7289/V5D21VHZ [05/30/2024].
...
![png](get_started_with_open_reproducible_science_files/get_started_with_open_reproducible_science_28_1.png)
...
rapid_df.plot(
    ...
    color='forestgreen',
    y='TOBS',
    title='Rapid City, SD, Observed Temperature',
    legend='false',
    xlabel='Year',
...
```
    ...
    <Axes: title={'center': 'Rapid City, SD, Observed Temperature'}, xlabel='Year', ylabel='Observed Temperature'>




    
![png](get_started_with_open_reproducible_science_files/get_started_with_open_reproducible_science_30_1.png)
...
```
    ...
    /tmp/ipykernel_77131/956040032.py:2: SettingWithCopyWarning: 
...
```
    ...
    /tmp/ipykernel_77131/4202370243.py:5: SettingWithCopyWarning: 
    A value is trying to be set on a copy of a slice from a DataFrame.
    Try using .loc[row_indexer,col_indexer] = value instead
...
```
    ...
    /tmp/ipykernel_77131/2539932020.py:2: FutureWarning: 'Y' is deprecated and will be removed in a future version, please use 'YE' instead.
      rapid_yearly_mean = rapid_1983_2023.resample('Y').mean()
...
![png](get_started_with_open_reproducible_science_files/get_started_with_open_reproducible_science_43_1.png)
...
## **Evidence points to Rapid City Temperature declining since 80s** 📰 🗞️ 📻

*The temperatures in Rapid City have declined since the 1988 based on average yearly temperatures. The average yearly temperature has more variation as time progresses, ranging between 1.5°C to 6°C.*
...
%%capture
%%bash
jupyter nbconvert get_started_with_open_reproducible_science*.ipynb --to markdown
```
